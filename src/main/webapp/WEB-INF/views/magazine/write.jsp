...
<script>
	function register() {
		...
		document.form1.action = "/magazine/insert.do";
...
<body>
	...
	<form name="form1" method="post" enctype="multipart/form-data">
		<div class="row justify-content-center"
			...
			<p class="title" style="margin: 20px 0 10px 20px">메거진 게시</p>
			...
			<div class=border1 style="width: 95%">
				<div class="row">
					<div>
						...
						<div>
							<input type="file" name="file1" value="사진업로드"
			...
			<div class="row">
				<div align="center">
					<input type="button" class="btn1" value="메거진 게시"
						onclick="register()">
