...
<script>
	function back() { 
		...
		if(address2==""){
			...
			alert("회원가입이 완료되었습니다.");
			document.getElementById("form1").action="/member_origin/insert.do";
	...
	<form name="form1" id="form1" method="post">
		...
		<hr style="border: 1px solid #444; margin: 5px 0 20px 0;">
			...
			<div style="display: flex; align-items: center; margin-left: 20px; ">
				...
				<button id="adbt" type="button" onclick="showPostcode()" style="width: 200px; font-weight: bold; font-size: 15px; height: 40px;">주소 찾기</button>
				</div>
				<div style="display: flex; align-items: center; margin-left: 20px; ">
			...
			<hr style="border: 1px solid #bbb; margin: 20px 0 25px 0;">
				...
				<div><input id="bluebt"  type="button" value="회원가입" onclick="back()" style="width: 250px; margin-left: 230px; font-size: 16px; font-weight: bold;"></div>
